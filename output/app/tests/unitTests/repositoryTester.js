    ...
    describe('#GETBYID', function () {
        context('when with valid id and table', function () {
            it('should return the data', function () {
                ...
                mut.getById(uuid.v4(), 'someTable').fork(function (x) {
                    return x.must.be['true']();
                }, function (x) {
                    return x.some.must.be.equal('data');
                });
            });
        });
        ...
        context('when throwing error on query', function () {
            it('should return the error', function () {
                ...
                mut.getById(uuid.v4(), 'someTable').fork(function (x) {
                    return x.must.equal('queryError');
                }, function (x) {
                    return x.must.be['true']();
                });
            });
    ...
    describe('#SAVE', function () {
        context('when without id', function () {
            it('should return the success', function () {
                ...
                mut.save('table', { doc: 'ument' }).fork(function (x) {
                    return x.must.be['true']();
                }, function (x) {
                    return x.must.be.equal('success');
                });
            });
        });
        ...
        context('when with id', function () {
            it('should return the success', function () {
                pgClient.returnResult('success');
                mut.save('table', { doc: 'ument' }, uuid.v4()).fork(function (x) {
                    return x.must.be['true']();
                }, function (x) {
                    return x.must.be.equal('success');
                });
    ...
    describe('#QUERY', function () {
        context('when calling with successful query', function () {
            it('should return success', function () {
                pgClient.returnResult('success');
                mut.query('some query').fork(function (x) {
                    return x.must.be['true']();
                }, function (x) {
                    return x.must.be.equal('success');
                });
    ...
    describe('#CHECKIDEMPOTENCY', function () {
        context('when calling with successful query', function () {
            it('should return success', function () {
                ...
                mut.checkIdempotency({ CommitPosition: 100 }).fork(function (x) {
                    return x.must.be['true']();
                }, function (x) {
                    return x.must.be['true']();
                });
        ...
        context('when calling with missing input', function () {
            it('should not blow up', function () {
                pgClient.returnResult({ CommitPosition: 1 });
                mut.checkIdempotency({}).fork(function (x) {
                    return x.must.be['true']();
                }, function (x) {
                    return x.must.be.empty();
                });
            });
        });
    ...
    describe('#RECORDEVENTPROCESSED', function () {
        context('when calling with successful query', function () {
            it('should return success', function () {
                ...
                mut.recordEventProcessed(originalPosition, 'handlerName').fork(function (x) {
                    return x.must.be['true']();
                }, function (x) {
                    return x.must.be.equal('success');
                });
